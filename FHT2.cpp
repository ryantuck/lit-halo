...
#include "decibel.inc"
    ...
    #if (LOG_OUT == 1)
        fht_log_out[(FHT_N/2)]; // FHT log output magintude buffer
    #endif
...
void FHT2::set_fht_input(int sample, int i)
{
    fht_input[i] = sample;
}
